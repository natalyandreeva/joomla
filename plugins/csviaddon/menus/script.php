...
class PlgcsviaddonmenusInstallerScript
{
	...
	public function postflight($parent)
	{
		...
		$folder = JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_menus';

		if (JFolder::create($folder))
		{
			// Copy the folder to the correct location
			$src = JPATH_SITE . '/plugins/csviaddon/menus/com_menus';
	...
	{
		// Remove the files
		if (file_exists(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_menus'))
		{
			JFolder::delete(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_menus');
		}
	}
}
