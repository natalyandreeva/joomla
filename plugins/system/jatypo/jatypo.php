...
class plgSystemJATypo extends JPlugin
{
	...
	function onAfterRoute()
	{
		...
		if( $this->allowUseTypo() ){
			...
			$doc->addScript($base_url.'/plugins/system/jatypo/jatypo/assets/script.js');
			$doc->addStylesheet($base_url.'/plugins/system/jatypo/jatypo/assets/style.css');
			$doc->addStylesheet($base_url."/plugins/system/jatypo/jatypo/typo/typo.css");
		}
	}
