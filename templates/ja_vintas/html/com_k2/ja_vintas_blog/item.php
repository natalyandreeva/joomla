...
<div id="k2Container" class="itemView itemViewBlog<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemLinks">
	  ...
	  <?php if($this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0)): ?>
		<div class="itemContentFooter">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<span><?php echo JText::_('K2_READ'); ?>:</span> <?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?>
			</span>
			<?php endif; ?>
