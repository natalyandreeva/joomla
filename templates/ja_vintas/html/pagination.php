...
function pagination_list_render($list)
{
	...
	$html .= "<li class='pages-count'>".JText::sprintf('JLIB_HTML_PAGE_CURRENT_OF_TOTAL', $currentPage, $pagesTotal)."</li>";
/*	foreach ($list['pages'] as $k => $page)
	{
...
/*	if ($item->text == JText::_('JLIB_HTML_START'))
	...
	{
		$display = '<span class="arrow-prev"></span>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<span class="arrow-next"></span>';
	}
...
/*	if ($item->text == JText::_('JLIB_HTML_START'))
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled"><a><span class="arrow-prev"></span></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><span class="arrow-next"></span></a></li>';
	}
