...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock list_item<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
	...
	<img src="<?php echo $item->authorAvatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" style="width:<?php echo $avatarWidth; ?>px;height:auto;" />
      ...
      <?php endif; ?>
      <div class="link-media clearfix">
	      <?php if($params->get('itemDateCreated')): ?>
	      <span class="moduleItemDateCreated"><?php echo JText::_('') ; ?> 
	      <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></span>
	      <?php endif; ?>
