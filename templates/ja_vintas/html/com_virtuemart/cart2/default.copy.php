...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	...
	<td align="right">
	   <div>
		<form action="<?php echo JRoute::_ ('index.php'); ?>" method="post" class="inline" id="updatecart_form<?php echo $pkey ?>" rel="<?php echo $pkey; ?>">
			<input type="hidden" name="option" value="com_virtuemart"/>
			<span class="quantity-controls">
		        <input type="button" class="quantity-controls quantity-minus" onclick="decrease_qty(<?php echo $pkey ?>);">
		    </span>
			<input type="text" title="<?php echo  JText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" id="quantity" class="inputbox" size="3" maxlength="4" name="quantity" value="<?php echo $prow->quantity ?>"/>
			<span class="quantity-controls">
