...
<?php   }
    ...
    ?>
    <form action="index.php" method="post" name="com-login" class="login-form" >
	<?php if (!$this->from_cart ) { ?>
	<div class="msg-info">
		<?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?>
	</div>
<div class="clear"></div>
<?php } else { ?>
        <p><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></p>
<?php }   ?>
        <p class="floatleft" id="com-form-login-username">
        ...
        <p class="floatleft" id="com-form-login-password">
        ...
        <p class="floatleft" id="com-form-login-remember">
