...
<div class="cart-view">
	<div class="page-heading">		
		<div class="width50 floatleft">
			<h1 class="vm-page-title"><?php echo JText::_('COM_VIRTUEMART_CART_TITLE'); ?></h1>
		</div>
...
<div class="billto-shipto"><p>Пожалуйста, корректно и полностью заполняйте свои контактные данные: обязательно ФИО, телефон, e-mail, а при способе доставки по почте также полный почтовый адрес, включая индекс.</p>
<br /><p>Если после оформления заказа на указанный Вами e-mail не пришло письмо с подтверждением приема заказа, то уточните у менеджеров по телефону либо электронной почте, принят ли Ваш заказ, либо оформите Ваш заказ повторно.</p>
<p><b>Среднее время обработки заказа составляет 2 недели.</b></p>
</div>
