...
echo '<div class="btn-contunueShopping"><a class="continue_link" href="' . $this->continue_link . '" >' . vmText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a></div>';
echo '<div class="btn-showCart"><a class="showcart floatright" href="' . $this->cart_link . '&mode=step1">' . vmText::_('COM_VIRTUEMART_CART_SHOW') . '</a></div>';
