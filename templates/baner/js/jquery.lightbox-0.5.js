...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'http://www.comandir.by/templates/a4joomla-mini-free/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'http://www.comandir.by/templates/a4joomla-mini-free/images/left.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'http://www.comandir.by/templates/a4joomla-mini-free/images/right.png',			// (string) Path and the name of the next button image
			imageBtnClose:			'http://www.comandir.by/templates/a4joomla-mini-free/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'http://www.comandir.by/templates/a4joomla-mini-free/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
