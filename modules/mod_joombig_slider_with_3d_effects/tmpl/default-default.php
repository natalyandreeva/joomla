...
<style>
	...
	.jms-slideshow {
		height: <?php echo ($moduleheight-24);?>px;
	}
	.step {	
		width: <?php echo ($modulewidth-40);?>px;
		height: <?php echo ($moduleheight-60);?>px;
	}
	.jms-wrapper {
		height: <?php echo ($moduleheight-44);?>px;
	}
	.jms-content{
				...
				if ($image[$loop] != 'image'.$loop.'joombig.jpg')
				{
					...
					?>
							...
							<div class="jms-content">
								<h3><?php echo $title[$loop]; ?></h3>
								<p><?php echo $info[$loop]; ?></p>
